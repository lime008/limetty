...
"
"   limetty             XTERM
let s:base00 = '{{color "black"}}' "236
let s:base01 = '{{color "blacklight"}}' "237
let s:base02 = '{{color "purp"}}' "238
let s:base03 = '{{color "mobster"}}' "244
let s:base04 = '{{color "pearl"}}' "248
let s:base05 = '#e2e4e5' "254
let s:base06 = '#eff0eb' "255
let s:base07 = '{{color "limelight"}}' "15
let s:base08 = '{{color "cinnabar"}}' "203
let s:base09 = '{{color "sunglow"}}' "215
let s:base0A = '{{color "sundance"}}' "229
let s:base0B = '{{color "lime"}}' "84
let s:base0C = '{{color "eucalyptus"}}' "123
let s:base0D = '{{color "picton"}}' "81
let s:base0E = '{{color "frosse"}}' "205
let s:base0F = '{{color "charm"}}' "131
